...
#    Removed Assignment and Constant as they can be represented as Let
#
...
class Let(Node):
    __slots__ = ('function_name', 'lvalue', 'rvalue', 'in_statement', 'coord', '__weakref__')

    def __init__(self, function_name, lvalue, rvalue, in_statement, coord=None):
